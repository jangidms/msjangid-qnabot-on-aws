...
module.exports = {
    ...
    SagemakerInitialInstanceCount: process.env.LAUNCH_OPTIONS_SagemakerInitialInstanceCount || 1,
    EmbeddingsLambdaArn: process.env.LAUNCH_OPTIONS_EmbeddingsLambdaArn || '',
    EmbeddingsLambdaDimensions: process.env.LAUNCH_OPTIONS_EmbeddingsLambdaDimensions || 1536,
    ...
    LLMSagemakerInitialInstanceCount: process.env.LAUNCH_OPTIONS_LLMSagemakerInitialInstanceCount || 1,
    ...
    ElasticSearchEBSVolumeSize: process.env.LAUNCH_OPTIONS_ElasticSearchEBSVolumeSize || 10,
    KibanaDashboardRetentionMinutes: process.env.LAUNCH_OPTIONS_KibanaDashboardRetentionMinutes || 43200,
